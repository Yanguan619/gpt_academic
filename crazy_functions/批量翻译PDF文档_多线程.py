...
def 解析PDF(file_manifest, project_folder, llm_kwargs, plugin_kwargs, chatbot, history, sys_prompt):
    ...
    for index, fp in enumerate(file_manifest):
        ...
        # 更新UI
        generated_conclusion_files.append(f'{LOG_DIR}/{create_report_file_name}')
        ...
        try:
            ...
            generated_html_files.append(f'{LOG_DIR}/{create_report_file_name}')
        except:
    ...
    for pdf_path in generated_conclusion_files:
        # 重命名文件
        rename_file = f'{LOG_DIR}/翻译-{os.path.basename(pdf_path)}'
    ...
    for html_path in generated_html_files:
        # 重命名文件
        rename_file = f'{LOG_DIR}/翻译-{os.path.basename(html_path)}'
        if os.path.exists(rename_file):
            os.remove(rename_file)
